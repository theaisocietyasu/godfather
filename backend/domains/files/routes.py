...
from domains.files.service import PodFileManager
...
def get_file_manager_for_pod(pod_id: str):
    """Build a connected PodFileManager for a pod.

    Returns (file_manager, key_path) on success, or (None, (jsonify, status_code)) on failure.
    """
