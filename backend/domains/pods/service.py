...
from shared.database import pods_collection
...
class PodService:
    """Pod operations against the RunPod API, merged with our MongoDB metadata"""

    @staticmethod
    def get_all_pods() -> List[Dict]:
        """Get all pods, merging RunPod state with our stored metadata"""
        try:
    ...
    def create_pod(config: Dict, creator_id: str, ssh_public_key: str) -> Optional[Dict]:
        ...
        try:
            ...
            # These are our own fields, not part of the RunPod API payload
