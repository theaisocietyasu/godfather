    ...
    <div className="min-h-screen bg-bg">
            ...
            <Card>
              ...
              <CardBody className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Toggle checked={pod.is_public} onChange={togglePublicAccess} label="Public access" />
                </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Toggle
              ...
              onChange={(checked) => setEditForm({ ...editForm, is_public: checked })}
              label="Public access"
            />
          </div>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          ...
          handlePodAction('terminate');
        }}
        title="Terminate pod"
        description={`This permanently destroys "${pod.name}" and its storage. This action cannot be undone.`}
